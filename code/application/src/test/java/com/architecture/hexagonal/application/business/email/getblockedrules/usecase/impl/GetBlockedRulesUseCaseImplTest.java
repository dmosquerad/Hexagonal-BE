package com.architecture.hexagonal.application.business.email.getblockedrules.usecase.impl;
...
class GetBlockedRulesUseCaseTest {
  ...
  @InjectMocks GetBlockedRulesUseCaseImpl getBlockedRulesUseCase;
