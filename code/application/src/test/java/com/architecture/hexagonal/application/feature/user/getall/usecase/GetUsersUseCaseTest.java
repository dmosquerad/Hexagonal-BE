...
class GetUsersUseCaseTest {
  ...
  void execute_shouldReturnUsers_whenNoFilterIsApplied() {
    ...
    final GetUsersQuery getUsersQuery = GetUsersQueryTestDataBuilder
        .builder()
        .host(host)
  ...
  void execute_shouldReturnBlockedEmailUsers_whenBlockEmailIsTrue() {
    ...
    final GetUsersQuery query = GetUsersQuery.builder()
        .host(host)
        .blockEmail(blockEmail)
    ...
    PaginationResult<User> result = getUsersUseCase.execute(query);
