package com.architecture.hexagonal.application.user.update.usecase.impl;
...
import com.architecture.hexagonal.application.testutils.user.update.input.UpdateUserCommandTestDataBuilder;
...
class UpdateUserUseCaseImplTest {
  ...
  void execute_shouldUpdateUser_whenUserExists()
    ...
    final UpdateUserCommand updateUserCommand =
        UpdateUserCommandTestDataBuilder.builder().build().updateUserCommand();
    ...
    final User result = updateUserUseCaseImpl.execute(updateUserCommand);
  ...
  void execute_shouldThrowPolicyViolationException_whenEmailIsBlocked() {
    ...
    AssertionsForClassTypes.assertThatThrownBy(
            () -> updateUserUseCaseImpl.execute(updateUserCommand))
