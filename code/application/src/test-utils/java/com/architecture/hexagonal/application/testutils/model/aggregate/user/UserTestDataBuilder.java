package com.architecture.hexagonal.application.testutils.model.aggregate.user;

import com.architecture.hexagonal.application.testutils.model.vo.email.EmailVoTestDataBuilder;
