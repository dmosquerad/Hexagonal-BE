...
@SpringBootTest(classes = {UserRepositoryDatabaseReadAdapterImpl.class})
@Transactional
@Sql(scripts = "/user/user.sql", executionPhase = Sql.ExecutionPhase.BEFORE_TEST_CLASS)
@ContextConfiguration(classes = TestApplication.class)
class UserRepositoryDatabaseReadAdapterImplTestIT extends DatabaseIT {

  @Autowired
  UserRepositoryDatabaseReadAdapterImpl userRepositoryDatabaseReadAdapterImpl;
  ...
  void getAllUsers_shouldReturnAllUsers_whenDatabaseHasUsers() {
    ...
    final PaginationResult<User> result = userRepositoryDatabaseReadAdapterImpl.getAllUsers("", pagination);
  ...
  void findUserById_shouldReturnUser_whenUserExists() {
    ...
    final Optional<User> result = userRepositoryDatabaseReadAdapterImpl.findUserById(user.getUser().getUserId());
  ...
  void getAllUsers_shouldReturnOnlyBlockedHostUsers_whenBlockHostFilterIsApplied() {
    ...
    final PaginationResult<User> result = userRepositoryDatabaseReadAdapterImpl.getAllUsers(
        "example",
        true,
