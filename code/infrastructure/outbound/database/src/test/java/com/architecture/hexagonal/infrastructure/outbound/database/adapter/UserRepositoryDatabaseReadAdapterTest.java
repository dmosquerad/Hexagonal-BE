...
class UserRepositoryDatabaseReadAdapterTest {
  ...
  @InjectMocks UserRepositoryDatabaseReadAdapter userRepositoryDatabaseReadAdapter;
  ...
  void findUserById_shouldReturnUser_whenUserExists() {
    ...
    final Optional<User> result =
        userRepositoryDatabaseReadAdapter.findUserById(userDao.getUserId());
  ...
  void getAllUsers_shouldReturnPagedUsersByHostAndBlockedHosts() {
    ...
    PaginationResult<User> result =
        userRepositoryDatabaseReadAdapter.getAllUsers(
            host,
            blockEmail,
  ...
  void getAllUsers_shouldReturnAllUsers_whenOnlyHostIsProvided() {
    ...
    PaginationResult<User> result = userRepositoryDatabaseReadAdapter.getAllUsers(host);
