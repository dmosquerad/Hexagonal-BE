...
class UserRepositoryDatabaseWriteAdapterImplTest {

  @InjectMocks UserRepositoryDatabaseWriteAdapterImpl userRepositoryDatabaseWriteAdapterImpl;
  ...
  void deleteUser_shouldReturnUser_whenUserExists() {
    ...
    final Optional<User> result = userRepositoryDatabaseWriteAdapterImpl.deleteUser(user.getId());
  ...
  void deleteUser_shouldReturnEmpty_whenUserNotFound() {
    ...
    final Optional<User> result =
        userRepositoryDatabaseWriteAdapterImpl.deleteUser(userDao.getUserId());
