...
class UserRepositoryDatabaseReadAdapterImplTest {

  @InjectMocks UserRepositoryDatabaseReadAdapterImpl userRepositoryDatabaseReadAdapterImpl;

  @Mock UserDatabaseReadRepository userDatabaseReadRepository;
  ...
  void getAllUsers_shouldReturnAllUsers_whenNoFiltersAreApplied() {
    ...
    Mockito.when(
            userDatabaseReadRepository.findAll(
    ...
    PaginationResult<User> result =
        userRepositoryDatabaseReadAdapterImpl.getAllUsers(host, pagination);
    ...
    Mockito.verify(userDatabaseReadRepository)
  ...
  void findUserById_shouldReturnUser_whenUserExists() {
    ...
    final Optional<User> result =
        userRepositoryDatabaseReadAdapterImpl.findUserById(userDao.getUserId());
  ...
  void getAllUsers_shouldReturnPagedUsersByHostAndBlockedHosts() {
    ...
    PaginationResult<User> result =
        userRepositoryDatabaseReadAdapterImpl.getAllUsers(
            host,
            blockEmail,
  ...
  @Test
  void getAllUsers_shouldReturnAllUsers_whenOnlyHostIsProvided() {
    final String host = "example";
    final UserDao userDao = UserDaoTestDataBuilder.builder().build().userDao();
    ...
    PaginationResult<User> result = userRepositoryDatabaseReadAdapterImpl.getAllUsers(host);
  ...
  void getAllUsers_shouldReturnSecondPage_whenCustomPaginationIsProvided() {
    ...
    final Pagination pagination =
        PaginationTestDataBuilder.builder().page(1).size(5).build().pagination();
