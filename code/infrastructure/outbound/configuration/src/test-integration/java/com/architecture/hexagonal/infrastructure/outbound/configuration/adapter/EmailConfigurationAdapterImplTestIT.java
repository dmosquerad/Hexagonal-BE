...
@SpringBootTest(classes = EmailConfigurationAdapterImpl.class)
@ContextConfiguration(classes = TestApplication.class)
class EmailConfigurationAdapterImplTestIT {

  @Autowired
  EmailConfigurationAdapterImpl emailConfigurationAdapterImpl;
